...
public interface TSysUserRoleDao {
     ...
     * @return 对象列表
     */
    List<TSysUserRole> queryAllByLimit(@Param("offset") int offset, @Param("limit") int limit);
     ...
     * @return 对象列表
     */
    List<TSysUserRole> queryAll(TSysUserRole tSysUserRole);
     ...
     * @return 影响行数
     */
    int insert(TSysUserRole tSysUserRole);
     ...
     * @return 影响行数
     */
    int update(TSysUserRole tSysUserRole);
